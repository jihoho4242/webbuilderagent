...
- Tool gateway: gateway_demo_passed (finish demo + L3 boolean rejection + L3 hash-bound approval artifact fixture; full side-effect gateway audit not attached; production gate blocked)

...
module Aiweb
  class CLI
    ...
    WEBBUILDER_COMMANDS = %w[
      ...
      engine-run engine-scheduler mcp-broker agent agent-run verify-loop eval-baseline human-baseline qa-checklist qa-report repair qa-playwright qa-screenshot qa-a11y qa-lighthouse visual-critique visual-polish advance rollback resolve-blocker snapshot

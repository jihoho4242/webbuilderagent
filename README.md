...
./bin/aiweb agent-run --task latest --agent openmanus --sandbox docker --approved
./bin/aiweb verify-loop --max-cycles 3 --approved
./bin/aiweb verify-loop --max-cycles 3 --agent openmanus --sandbox docker --approved
